...
# query = python script_py.py "Brandywine Amherst MA" "UMass Amherst" "minimize" "bike"
# query = python script_py.py "Brandywine Amherst MA" "UMass Amherst" "minimize" "walk"
